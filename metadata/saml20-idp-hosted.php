...
$metadata['__DYNAMIC:1__'] = array(
    ...
    'SingleSignOnServiceBinding' => array("urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST", "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect"),
    'SingleLogoutServiceBinding' => array("urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST", "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect"),
